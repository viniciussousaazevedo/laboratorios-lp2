...
class PecaTest {
	...
	@Test
	void testPecaPersonalizada() throws Exception {
		PersonalizacaoDePeca personalizacao = new PersonalizacaoDePeca("a", "b", "c", "d", "e", "f", "g");
		assertEquals("a:g", new Peca(0, 6, personalizacao).toString());
		assertEquals("b:f", new Peca(1, 5, personalizacao).toString());
	}
}
