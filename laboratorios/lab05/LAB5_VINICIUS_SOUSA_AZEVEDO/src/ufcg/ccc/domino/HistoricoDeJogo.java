...
public class HistoricoDeJogo {
	...
	/**
	 * @return valor booleano que informa se o jogou ganhou por desempate
	 */
	public boolean isVitoriaPorDesempate() {
		if (this.jogador1.getNome().equals(vencedor)) {
			return this.jogador1.getNumPecas() != 0;
		} else {
			return this.jogador2.getNumPecas() != 0;
		}
	}
	...
	public Jogada getJogadaVencedora() {
		...
		if (this.getVencedor().equals("J1")) {
			retorno = this.rodadas.get(this.rodadas.size()-1).getJogadaJ1();
		} else {
			retorno = this.rodadas.get(this.rodadas.size()-1).getJogadaJ2(); 
		}
		return retorno;
	}
	...
	/**
	 * @return quantidade de pontos do vencedor
	 */
	...
	private class SituacaoNoJogo {
		...
		public Jogada getJogadaJ1() {
			return this.jogadaJ1;
		}
		
		public Jogada getJogadaJ2() {
			return this.jogadaJ2;
		}
